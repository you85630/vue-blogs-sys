...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/components/pages/newsredact.vue
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-2d114574","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/pages/newsredact.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"redact"},[_c('back-btn'),_vm._v(" "),_c('ul',[_c('li',[_c('p',[_vm._v("标题：")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.redact.title),expression:"redact.title"}],attrs:{"type":"text","name":"title"},domProps:{"value":(_vm.redact.title)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.redact, "title", $event.target.value)}}})]),_vm._v(" "),_c('li',[_c('p',[_vm._v("标签：")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.redact.label),expression:"redact.label"}],attrs:{"type":"text","name":"label"},domProps:{"value":(_vm.redact.label)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.redact, "label", $event.target.value)}}})]),_vm._v(" "),_c('li',[_c('p',[_vm._v("简介：")]),_vm._v(" "),_c('textarea',{directives:[{name:"model",rawName:"v-model",value:(_vm.redact.message),expression:"redact.message"}],attrs:{"name":"message"},domProps:{"value":(_vm.redact.message)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.redact, "message", $event.target.value)}}})]),_vm._v(" "),_c('li',[_c('p'),_vm._v(" "),_c('button',{on:{"click":_vm.pushList}},[_vm._v("提交")])])])],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ var pages_newsredact = (esExports);
// CONCATENATED MODULE: ./src/components/pages/newsredact.vue
function injectStyle (ssrContext) {
  __webpack_require__("Q+Vl")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-2d114574"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  newsredact,
...
/* harmony default export */ var components_pages_newsredact = __webpack_exports__["default"] = (Component.exports);
