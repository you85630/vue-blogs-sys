...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/components/pages/newsList.vue
...
/* harmony default export */ var newsList = ({
  ...
  computed: extends_default()({}, Object(vuex_esm["c" /* mapGetters */])(['newsTitle', 'newsList'])),
  methods: extends_default()({}, Object(vuex_esm["b" /* mapActions */])(['removeList', 'searchList']))
});
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-6ba21472","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/pages/newsList.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"news-list"},[_c('add-btn'),_vm._v(" "),_c('my-search',{on:{"search":_vm.searchList}}),_vm._v(" "),(_vm.newsList.length)?_c('my-tables',{attrs:{"headline":_vm.newsTitle,"tableData":_vm.newsList},on:{"remove":_vm.removeList}}):_c('data-none')],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ var pages_newsList = (esExports);
// CONCATENATED MODULE: ./src/components/pages/newsList.vue
function injectStyle (ssrContext) {
  __webpack_require__("0vew")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-6ba21472"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  newsList,
...
/* harmony default export */ var components_pages_newsList = __webpack_exports__["default"] = (Component.exports);
